    ...
    <div class="row">
      ...
      <div class="box-body">
                ...
                <div class="row">
                  ...
                  <div class="col-md-2">
                    <a type="button" class="btn btn-block btn-primary" href="<?= base_url()."main_admin" ?>">Kembali</a>
                  </div>

                  <div class="col-md-3">
                    <a type="button" class="btn btn-block btn-primary" data-toggle="modal" data-target="#modal-default">Upload Dokumen Pegawai non-aktif</a>
                  ...
                  <div class="modal-dialog">
                    <div class="modal-content">
                      <div class="modal-header">
                        ...
                        <h4 class="modal-title">Upload Dokumen Pegawai</h4>
                      </div>
                           ...
                           <div class="box-body">
                             <div class="form-group">
                               ...
                               <select class="form-control">
                                 <option>Abrar Anugrah</option>
                                <option>Chairul Anwar</option>
                                <option>Donny Dharmawan</option>
                                <option>Jhan Ivander</option>
                                <option>Rizky Nirwan</option>
                              </select>
